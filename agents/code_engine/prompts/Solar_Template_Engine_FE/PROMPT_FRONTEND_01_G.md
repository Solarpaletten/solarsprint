...
// PURPOSE: Implement Projects List Page with CRUD operations
// VERSION: 1.0
...
TASK:
Implement Projects List Page — display all projects with create and delete functionality.
...
5. Page sections:
   a. Header: "Projects" title + "New Project" button
   b. Create form (conditional): inline form when isOpen
   c. Projects grid: cards with name, description, actions

6. UI states:
   - Loading: Show loading text
   - Error: Show error message
   - Empty: Show "No projects" with create CTA
   - Data: Show projects grid

7. Styling (Tailwind classes):
   - Container: p-8
   - Header: flex, justify-between, items-center, mb-6
   - Title: text-2xl, font-bold, text-gray-900
   - Create button: px-4, py-2, bg-blue-600, text-white, rounded-lg, hover:bg-blue-700
   - Form card: bg-white, p-6, rounded-xl, shadow-sm, border, mb-6
   - Input: w-full, px-4, py-2, border, border-gray-300, rounded-lg, focus:ring-2, focus:ring-blue-500
   - Projects grid: grid, grid-cols-1, md:grid-cols-2, lg:grid-cols-3, gap-4
   - Project card: bg-white, p-5, rounded-xl, shadow-sm, border, border-gray-100, hover:shadow-md
...
- Refetch list after create/delete operations
- Export ProjectsPage as default function
...
OUTPUT FORMAT:
<complete app/(dashboard)/projects/page.tsx source code only>
